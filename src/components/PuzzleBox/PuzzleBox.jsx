...
const PuzzleBox = ({ boardConfig, correctMovesArr, modalMsg }) => {
  ...
  useEffect(() => {
    ...
    console.log( correctMove % 2 === 0 );
    console.log(correctMove !== 0 );
    console.log(correctMove < correctMovesArr.length );
    ...
    if (
      ...
      console.log("useeffect condition triggered");
